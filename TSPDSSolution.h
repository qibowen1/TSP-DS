...
struct TSPDSSolution {
    ...
    double cplex_best_integer = std::numeric_limits<double>::infinity();
    double cplex_best_bound = std::numeric_limits<double>::infinity();
    double cplex_mip_gap = std::numeric_limits<double>::infinity();
    int cplex_status = 0;
    std::string cplex_status_name;
    std::string cplex_result_type;
    double cplex_find_best_time = 0.0;
    bool cplex_feasible_solution = false;
    std::string cplex_feasible_info;
